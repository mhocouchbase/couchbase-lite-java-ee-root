#!/bin/bash
#
# Build Couchbase Lite Android Kotlin Extensions, Enterprise Edition
#
...
echo "======== BUILD Couchbase Lite Android Kotlin Extensions, Enterprise Edition v`cat ../../version.txt`-${BUILD_NUMBER}"
...
#pushd lib/build
#zip -r "${REPORTS}/analysis-reports-android-ee-ktx" reports
#popd

echo "======== BUILD COMPLETE (${STATUS}) Couchbase Lite Android Kotlin Extensions, Enterprise Edition"
exit $STATUS
