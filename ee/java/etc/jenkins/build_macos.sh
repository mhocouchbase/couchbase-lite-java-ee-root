#!/bin/bash
#
# Build Couchbase Lite Java for MacOS, Enterprise Edition
#
...
echo "======== BUILD Couchbase Lite Java for MacOS, Enterprise Edition v`cat ../../version.txt`-${BUILD_NUMBER}"

echo "======== Clean up ..." 
"${TOOLS_DIR}/clean_litecore.sh"

echo "======== Download Lite Core ..."
"${TOOLS_DIR}/fetch_litecore.sh" -e EE -n "${NEXUS_URL}"
